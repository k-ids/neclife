    ...
    class Production extends MY_Controller {
        ...
        */
        ...
        public function add_packing_list_form($id ='', $itemId = '') {
            ...
            if(empty($findone) || empty($item) || ( ($this->session->userdata('department') != $findone['department'])  && ($this->session->userdata('admin_id') != '1') ) ) {
        ...
        */
        ...
        public function gsk() {
          ...
          if($this->session->userdata('error')) {
            ...
            $da_entry_list = $this->da_header->all_api_da_entry($where, array('type' => 0));
