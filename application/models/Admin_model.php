...
class Admin_model extends MY_Model {
        ...
        public function check_unique_email_field_name($id = '', $field) {
        ...
        public function check_unique_username_field_name($id = '', $field) {
        ...
        public function findAllUser() {
             ...
             $select = "".$this->_table.".*, user_roles.role as role, department.department as dept_name, datype.datype as datype_name "; 
            $this->db->select( $select );
            $this->db->from($this->_table);
            $this->db->join('user_roles', $this->_table.'.admin_group = user_roles.id', 'left');
        ...
        public function adminLogin($postData) {
        	...
        	if ($query->num_rows() > 0) {
                ...
                $this->session->set_userdata("da_type", $q->da_type);
                $this->session->set_userdata("department", $q->department);
        		$this->session->set_userdata("loggedin",1);
                $this->session->set_userdata('role', $q->admin_group);
