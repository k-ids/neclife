<?php
    ...
    class Ppic extends MY_Controller {
        ...
        public function __construct() {
            ...
            $this->daType = $this->session->userdata('da_type');
        ...
        */
        ...
        public function index() {
            ...
            if($this->session->userdata('admin_id') != '1' ) {
             ...
             $conditionsCheckArray = array('type' => 0, 'da_checked' => 1, 'bussiness_manger_checked' => 1, 'approved' => 1, 'outstanding_checked' => 1, 'account_approved' => 1 , 'final_approved' => 1);

             $da_entry_list = $this->da_header->getAllDAForPPIC($where, $conditionsCheckArray);
        ...
        */
        ...
        public function reassign_da() {
            ...
            // $conditionsCheckArray = array('type' => 0, 'da_checked' => 1, 'bussiness_manger_checked' => 1, 'approved' => 1, 'outstanding_checked' => 1, 'account_approved' => 1 , 'final_approved' => 1);
             $da_entry_list = $this->da_header->getAllDAForPPIC($where, null);
