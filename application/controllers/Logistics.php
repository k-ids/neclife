    ...
    class Logistics extends MY_Controller {
        ...
        public function da_check_form($id = '') {
            ...
            if(!empty($post)) {
               ...
               if(!empty($update)) {
                    ...
                    $this->session->set_flashdata('success','DA checked and successfully sent for the bussiness manager checking!');
        ...
        */
        ...
        public function da_approve() {
            ...
            $da_entry_list = $this->da_header->get_all_da_entry($where, array('type' => 0), array('da_checked' => 1, 'bussiness_manger_checked' => 1, 'approved' => 0));
        ...
        public function da_approve_form($id = '') {
            ...
            if(!empty($post)) {
               ...
               if(!empty($update)) {
                    ...
                    $this->session->set_flashdata('success','DA Approved and successfully sent for the outstanding check!');
        ...
        */
        ...
        public function da_final_approve() {
            ...
            $da_entry_list = $this->da_header->get_all_da_entry($where, array('type' => 0), array('da_checked' => 1, 'bussiness_manger_checked' => 1, 'approved' => 1, 'outstanding_checked' => 1, 'account_approved' => 1 , 'final_approved' => 0));
        ...
        */
        ...
        public function da_revised() {
           ...
           $da_entry_list = $this->da_header->get_all_da_entry($where, array('type' => 0), array('da_checked' => 1, 'approved' => 1, 'final_approved' => 1));
        ...
        */
        ...
        public function bussiness_manager_check_da() {
            ...
            {
                $da_entry_list = $this->da_header->get_all_da_entry($where, array('type' => 0), array('da_checked' => 1, 'bussiness_manger_checked'=> 0 , 'ordered_by' => $this->session->userdata('admin_id')));

            } else {
                $da_entry_list = $this->da_header->get_all_da_entry($where, array('type' => 0), array('da_checked' => 1, 'bussiness_manger_checked'=> 0));
        ...
        public function bussiness_manager_check_da_form($id = '') {
            ...
            if(!empty($post)) {
               ...
               if(!empty($update)) {
                    ...
                    $this->session->set_flashdata('success','DA checked successfully and sent for the approval!');
        ...
        */
        ...
        public function packing_list_raw_pdf($da_no = '', $product_form = '') {
            ...
            $mpdf->WriteHTML($html);
            $filename = !empty($findAll[0]['daname']) ? $findAll[0]['daname'] : '';
            $mpdf->Output($filename.'-Packing List Raw Data.pdf', 'D'); 
