...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">Packing List - View Raw Data</li>
...
<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b>Packing List - View Raw Data</b>
   </div>
</div>

<div class="alert alert-info">
  <strong>Info!</strong> Listing of all Packing List Raw Data.
</div>
         ...
         <table class="table table-bordered" width="200%" id="dataTable" cellspacing="0">
            <thead>
               <tr>
                  ...
                  <th>Packing Type</th>
                  <th>DA Quantity</th>
                  <th style="width: 100px;">Packing List Date</th>
                  <th>Action</th>
               </tr>
            </thead>
            <tfoot>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><a class="btn btn-primary" href="<?= base_url(). $this->router->fetch_class(). '/packing_list_view_raw/'.$value['da_no'].'/'.$value['product_form'] ?>"><i class="fa fa-check"></i>&nbsp;Select</a></td>
