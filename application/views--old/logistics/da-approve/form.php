...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().'logistics/da_approve'?>">DA Approve Form</a></li>
</ol>
<!-- Example Tables Card -->

<div class="card mb-3">
   <div class="card-header">
      <i class="fa fa-dashcube" style="color: green;"></i>&nbsp;<b>DA Approve Form</b>
   </div>
      <div class="card-block">
          <form action="<?= base_url().'logistics/da_approve_form/'.$da_header['id']?>" method="POST">
            ...
            <a href="<?= base_url().'logistics/da_approve'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>
               ...
               <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to approve the DA"><i class="fa fa-floppy-o"></i>&nbsp;Approve</button>
            <form>
      </div>
</div>
<div class="card mb-3">
      ...
      <div class="card-block">
       <p><strong>Note:</strong></p>
         <ul>
          <li class="text-success"> This DA has been successfully checked by <b><?= getUserName($findOne['checked_by']) ?></b></li>
          <li class="text-info">Please review the DA and provide approval. Once DA approved, will send to final approval.</li>
