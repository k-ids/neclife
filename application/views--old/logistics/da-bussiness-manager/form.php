...
<div class="card mb-3">
   <div class="card-header">
      ...
      <div class="card-block">
          <form action="<?= base_url().'logistics/bussiness_manager_check_da_form/'.$da_header['id']?>" method="POST">
         
            <a href="<?= base_url().'logistics/da_check'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>

               <input type="hidden" name="check" value="true">
               <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to check the DA"><i class="fa fa-floppy-o"></i>&nbsp;Bussiness Manager Check</button>
            </form>
       ...
       <p><strong>Note:</strong></p>
         <ul>
          <li class="text-success"> This DA has been successfully prepared by <b><?= getUserName($findOne['prepared_by'])?></b>
            <ul>
              <li>Checked By:&nbsp;<b><?= getUserName($findOne['checked_by']) ?></b></li>
              <li>Approved By:&nbsp;<b><?= getUserName($findOne['approved_by']) ?></b></li>
              <li>Final Approved By:&nbsp;<b><?= getUserName($findOne['final_approved_by']) ?></b></li>
            </ul>
          </li>
          <li class="text-info">Please review the DA and marked as checked by clicking the button check at top. Once DA Checked, will send to approval.</li>
       ...
       <div class="table-responsive">
        ...
        <thead>
            <tr>
                ...
                <th>HS Code</th>
                <th>Product Form</th>
                <th style="width:110px !important; min-width: 110px !important;">Grade</th>
                <th>Packing Type</th>
                <th>Qty</th>
                <th>Rate</th>
                <th>Amount</th>
