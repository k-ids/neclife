...
<div class="card mb-3">
   <div class="card-header">
      ...
      <div class="card-block">
          <form action="<?= base_url().'logistics/da_check_form/'.$da_header['id']?>" method="POST">
            ...
            <a href="<?= base_url().'logistics/da_check'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>
               ...
               <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to check the DA"><i class="fa fa-floppy-o"></i>&nbsp;Check</button>
            </form>
...
<div class="card mb-3">
      ...
      <div class="card-block">
       <p><strong>Note:</strong></p>
         <ul>
          <li class="text-success"> This DA has been successfully prepared by <b><?= getUserName($findOne['prepared_by']) ?></b></li>
