		...
		<table class="outer" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="noBorder">
					...
					<tr>
						<td width="66%" style="padding: 5px 5px 5px 5px !important;">DISPATCH ADVICE - EXPORTS</td>
						<td width="34%" style="padding: 5px 5px 5px 5px !important;">THIS COPY TO: <span>ACCOUNT</span></td>
					</tr>
					<tr>
						<td style="padding: 5px 5px 5px 5px !important;">From: <span>Export</span></td>
						<td style="padding: 5px 5px 5px 5px !important;">To: <span><?= $da_header['datype_name'] ?></span></td>
					</tr>
				</table></td>
			</tr>
			<tr>
				<td style="padding: 5px 5px 5px 5px !important;">Please arrange to dispatch the below mentioned goods for our customer as per the confirmed writter order as per below mentioned details</td>
			</tr>
			<tr >
				<td class="noPadding">
					<table class="noOuterBorder" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					...
					<tr>
						<td class="noPadding"><table class="invoice" width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th width="20%" style="text-align: right; vertical-align:top; border-right: 0;">Amount<br/>
								<?= $da_header['currency_name'] ?></th>
							</tr>
					...
					<tr>
						<td class="noPadding"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="noBorder">
							<tr>
								<td width="66%" valign="top">Amount Chargeable(in words)): <?= $da_header['currency_name'] ?> <?= convert_number(!empty($sum) ? $sum: 0)?> Only<br/>
									
								<td width="34%" valign="top" align="right"><b><?=  !empty($da_items) ? number_format((float) $sum , 2, '.', '') : '' ?></b></td>
							</tr>
						</table></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="noPadding"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="invoice">
							<tr style="border-bottom: 1px solid #000;">
								...
								<th align="right" style="text-align: right;border-right: 0;">Net Price per Kg.</th>
							</tr>
							<?php if(!empty($da_items) ) {
                                $counter = 0;
                                foreach($da_items as $daitems) {
					...
					<tr>
						<td class="noPadding"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="invoice">
							<tr>
								...
								<th align="left" style="border-right: 0;">&gt;365 Days</th>
							</tr>
							...
							<tr>
                                ...
                                <td align="left" style="border-right: 0;"><?= $outstanding['GT365_days'] ?></td>
							</tr>
                            <?php }  }   else {?> 
                             <tr>
		                         <td align="left">&nbsp;</td>
		                         ...
		                         <td align="left">&nbsp;</td>
		                         <td align="left">&nbsp;</td>
		                         <td align="left" style="border-right: 0;">&nbsp;</td>
		                        </tr>
                            <?php } ?>
						</table></td>
					</tr>
					<tr>
						...
						<tr>
							<td style="border-bottom:0; border-top: 0; border-left: 0; border-right: 0;">O/S Payment Review <br/>Devinder Singh Rana</td>
							<td style="border-bottom:0; border-top: 0; border-left: 0; border-right: 0;">Approved By<br/>R. K. Aggarwal</td>
							<td style="border-bottom:0; border-top: 0; border-left: 0; border-right: 0;">Final Approval Given By<br/>Amit Chadah (President)</td>
