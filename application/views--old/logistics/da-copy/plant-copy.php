...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/da_plant'?>">DA PLant Copy</a></li>
   </li>
</ol>
    ...
    <div class="card-block">
        <div style="float: right;">
            ...
            <?php if(isset($findOne['cancelled']) && $findOne['cancelled'] =='0' ) {?>
               ...
               <!--  <button class="btn btn-danger" type="button" onclick="pdf('DA-Plant-<?= $da_header['da_no'] ?>')"><i class="fa fa-file-pdf-o"></i>&nbsp;PDF</button> -->
                
                 <a class="btn btn-danger" href="<?= base_url().'logistics/plant_pdf/'.$da_header['id']?>"><i class="fa fa-file-pdf-o"></i>&nbsp;PDF</a>

                <a class="btn btn-warning" href="<?= base_url().'logistics/download/'.$da_header['id']?>"><i class="fa fa-file-pdf-o"></i>&nbsp;Download Attachment</a>
			...
			<tr>
				<td class="noPadding"><table class="noOuterBorder" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<?= $da_header['currency_name'] ?></span> <span style="padding: 0 0 0 10px; width: 54% !important; display: inline-flex;"><?= convert_number(!empty($sum) ? $sum: 0)?> Only </span><span style="float:right"><strong><?=  !empty($da_items) ? number_format((float) $sum , 2, '.', '') : '' ?></strong></span></td>
					</tr>
					<tr>
						<td class="noPadding"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="noBorder">
							<tr>
