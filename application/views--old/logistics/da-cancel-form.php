...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?=base_url().'logistics/da_cancel'?>">DA Cancel</a></li>
   <li class="breadcrumb-item">DA Cancel Form</li>
...
<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b>DA Cancel Form</b>
   </div>
       <div class="card-block">
        
            <a href="<?= base_url().'logistics/da_cancel'?>" class="btn btn-warning"><i class="fa fa-search"></i>&nbsp;Find</a>
...
<div class="card mb-3">
   <div class="card-block">
      ...
      <form method="POST" action="<?= base_url().'logistics/da_cancel_form/'.$cancel['id']?>">
        <div class="row">
        
              <div class="col-md-6 form-group">
               <label>DA No:</label>
                  <input class="form-control" type="text" name="da_no" value="<?= $cancel['da_no'] ?>" readonly>
                   <?= form_error('da_no');?>
              </div>

              <div class="col-md-6 form-group">
               <label>Cancelled By:</label>
               <input class="form-control" type="text" name="cancelled_by" value="<?= $cancelled_by ?>" readonly>
                 <?= form_error('cancelled_by');?>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
               <label>Cancellation Date:</label>
                  <input class="form-control" type="text" name="cancellation_date" id="cancellation_date" value="<?= set_value('cancellation_date'); ?>" required>
                  <?= form_error('cancellation_date');?>
              </div>

              <div class="col-md-6 form-group">
               <label>Cancellation Remarks:</label>
                  <textarea  class="form-control" name="remarks" required><?= set_value('remarks'); ?></textarea>
                  <?= form_error('remarks');?>
              </div>

            </div>
              <button type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"></i>&nbsp;Save</button>
         <a href="<?= base_url().'logistics/da_cancel'?>" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;Cancel</a>
