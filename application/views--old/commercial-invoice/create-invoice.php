...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">Customs Invoice</a></li>
   </li>
</ol>
<div class="card mb-3">
   <div class="card-block">
      <div style="float: right;">
         <a href="<?= base_url().$this->router->fetch_class().'/commercial_invoice_pdf/customs/'.$invoice_data['invoice_id']?>" class="btn btn-danger"><i class="fa fa-files-o"></i>&nbsp;Download Customs Invoice</a>
      ...
      <table class="outer" width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
            ...
            <td width="34%" valign="top" style="border-right: 0 !important;">Invoice No. &amp; Date<br />
                  ...
                  Buyer's Order No.  &amp; Date<br /> <?= $invoice_data['buyer_order_number'] ?> <br><?= $invoice_data['buyer_order_date'] ?><br />
                ...
                <strong>DA NO. <?= $invoice_data['da_no_name'] ?> DATED <?= $invoice_data['da_date'] ?></strong> <br />
                 ...
                 <?php } ?>
                   ...
                   <?php if(!empty($invoice_data['indent_no'])) { ?>
                        <?= $invoice_data['indent_no'] ?> <?= $invoice_data['indent_date'] ?>
         ...
         <tr>
            <td style="border-right:0; border-bottom:0" colspan="3">
               <table width="100%" border="0" cellpadding="0" cellspacing="0" class="noBorder">
                  ...
                  <tr>
                     ...
                     <td>:</td>
                     <td><strong><?= $invoice_data['state'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>STATE CODE </strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['state_code'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>STATE OF ORIGIN </strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['state_of_origin'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>DISTT CODE </strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['district_code'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>DISTT OF ORIGIN </strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['district_of_origin'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>CIN NO. </strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['cin_no'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>GSTIN</strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['gstin'] ?></strong></td>
                  </tr>
                  <tr>
                     <td><strong>TIN NO.</strong></td>
                     <td>:</td>
                     <td><strong><?= $invoice_data['tin_number'] ?></strong></td>
                  </tr>
            ...
            <td style="border-left:0; border-bottom:0" colspan="3">
               <table class="border" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     <td><strong>Taxable Value (INR)</strong></td>
                     <td>:</td>
                     <td><?= $invoice_data['taxable'] ?></td>
                  </tr>
                  <tr>
                     <td><strong>IGST <?= $invoice_data['gst_per']?>% (INR)</strong></td>
                     <td>:</td>
                  ...
                  <tr>
                     <td width="30%"><strong>Exchange Rate (<?= $invoice_data['currency_name'] ?>)</strong></td>
                     <td width="4%">:</td>
                     <td><?= $invoice_data['exchange_rate'] ?></td>
                  </tr>
                  <?php } if($invoice_data['invoice_type'] =='2') { ?>
                  <tr>
                     <td>UNDER LUT</td>
                     <td>:</td>
                     <td><?= $invoice_data['eunder_lut'] ?></td>
                  </tr>
                  <?php } ?>
               </table>
            </td>
