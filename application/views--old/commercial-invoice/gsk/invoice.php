...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/gsk_packing_invoice'?>"> Invoice</a></li>
   <li class="breadcrumb-item">GSK Packing-Invoice</a></li>
   </li>
</ol>
<div class="card mb-3">
   ...
   <div class="card-block">
      ...
      <table class="outer" width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
            ...
            <td style="border-bottom:0" align="center" valign="top">
               <p><?= $value['kind_of_package'] ?> </p> <br>
               
            </td>
            <td style="border-bottom:0" align="center" valign="top">
               <p> <?= $value['description_of_goods'] ?> 
               <p> <br />
               <?php if($outerKey == ($count -1)) {
