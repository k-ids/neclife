...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/packing_list_invoice'?>">Invocie</a></li>
   <li class="breadcrumb-item">Download Packing List Invoice</a></li>
   </li>
</ol>
<div class="card mb-3">
    <div class="card-block">
      <div style="float: right;">
          ...
          <a href="<?= base_url().$this->router->fetch_class().'/packinglist_invoice_pdf/customs/'.$invoice_data['invoice_id']?>" class="btn btn-danger"><i class="fa fa-files-o"></i>&nbsp;Download Customs Invoice</a>

         <!--  <a href="javascript:void(0)" onclick="pdf('gg')" class="btn btn-danger"><i class="fa fa-files-o"></i>&nbsp;JS</a> -->
      
           <a href="<?= base_url().'/commercial_invoice/update_packinglist_invoice/'.$invoice_data['invoice_id']?>" class="btn btn-warning"><i class="fa fa-pencil"></i>&nbsp;Edit Invoice</a> 
      </div>
                ...
                <strong>DA NO. <?= $invoice_data['da_no_name'] ?> DATED <?= $invoice_data['da_date'] ?></strong> <br />
                 ...
                 <?php } ?>
                   ...
                   <?php if(!empty($invoice_data['indent_no'])) { ?>
                      </strong> <?= $invoice_data['indent_no'] ?> <?= $invoice_data['indent_date'] ?>
