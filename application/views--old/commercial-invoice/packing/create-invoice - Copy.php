                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="80%">
                            ...
                            <?php } ?>
                             ...
                             <td contenteditable="true" class="no"><?= ++$counter; ?></td>
                                    ...
                                    <td contenteditable="true" class="text-left"> <?=   number_format((float) $net_weight , 2, '.', '')?></td>

                                    <td contenteditable="true" class="text-left"> <?=   number_format((float) $gross_weight , 2, '.', '')?> </td>
                         ...
                         <br>
                          ...
                          <div class="row contacts">
                                ...
                                <div class="col invoice-details col-md-4" style="vertical-align: bottom;position: absolute;bottom: 82px;right: 0;text-align: right;padding: 40px;">
