...
<div class="card mb-3">
    <div class="card-block">
      <div style="float: right;">
          ...
          <a href="<?= base_url().$this->router->fetch_class().'/packinglist_invoice_pdf/customer/'.$invoice_data['invoice_id']?>" class="btn btn-danger"><i class="fa fa-files-o"></i>&nbsp;Download Customer Invoice</a>
