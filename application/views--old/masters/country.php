...
?>
            ...
            <div class="card mb-3">
                 ...
                 <div class="card-header">
                      <i class="fa fa-table" style="color: green;"></i> <b>Country listing</b>
                    </div>
                  <div class="card-block">
					...
					<form method="POST" id="collapseExample" class="collapse <?= !empty($this->session->userdata('error')) ? 'show': '' ?>" action="<?=base_url()?>masters/country_add" aria-exapnaded="<?= !empty($this->session->userdata('error')) ? 'true': 'false' ?>">
						...
						<div class="form-group">
							...
							<input type="text" name="country" class="form-control" placeholder="Enter country" id="country" value="<?= set_value('country') ?>">
							<?=  form_error('country') ?>
						</div>
						<div class="form-group">	
