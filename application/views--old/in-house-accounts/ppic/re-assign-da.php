...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">DA Re-Assign Production Block
</li>
...
<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b>DA Re-Assign Production Block
</b>
   </div>
</div>

<div class="alert alert-info">
  <strong>Info!</strong> Listing of all DA to Re-Assign Production Block.
</div>
