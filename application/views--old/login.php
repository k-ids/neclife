 ...
 <!--<div class="container">
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img style="padding-top:15px;" src="<?=base_url()?>resources/image/index.png" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form id="login-form" class="form-signin" action="<?=base_url()?>login" method="POST">
	<p><?php
            if ($error == 1) { echo "Too Many Login Attempts"; }
            if ($error == 2) { echo "Invalid Login Credentials."; }
        ?></p>
      ...
      <input type="submit" class="fadeIn fourth" value="Log In" class="hide-off">
       <button  class="btn btn-primary sp" type="button" disabled id="loader" style="display: none;" >
                
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      Copyright: Nectar Lifesciences Ltd.
    </div>
