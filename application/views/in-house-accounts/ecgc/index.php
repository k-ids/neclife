...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">In House Accounts</li>
   <li class="breadcrumb-item"> DA ECGC Check</li>
...
<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b> DA ECGC Check</b>
   </div>
</div>

<div class="alert alert-info">
  <strong>Info!</strong> Listing of all DA for ECGC Check.
</div>
               ...
               <tr>
                  ...
                  <td>
                     <?php if(empty($value['cancelled_by'])) { ?>
                        <a href="<?= base_url().$this->router->fetch_class().'/ecgc_check_form/'.$value['id'] ?>" class="btn btn-info"><i class="fa fa-recycle"></i>&nbsp;Select</a>
                      <?php } else { ?>
