...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item active">In House Accounts</li>
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/da_license_check'?>">DA ECGC Check</a></li>
</ol>
<!-- Example Tables Card -->

<div class="card mb-3">
   <div class="card-header">
      <i class="fa fa-dashcube" style="color: green;"></i>&nbsp;<b>DA ECGC Check</b>
   </div>
      <div class="card-block">
          <form action="<?= base_url().$this->router->fetch_class().'/'.$this->router->fetch_method().'/'.$da_header['id']?>" method="POST">
         
            <a href="<?= base_url().$this->router->fetch_class().'ecgc_check'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>

               <input type="hidden" name="check" value="true">
               <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to check the DA"><i class="fa fa-floppy-o"></i>&nbsp;ECGC Check</button>
            </form>
      ...
      <div class="card-block">
       <p><strong>Note:</strong></p>
         <ul>
          ...
          <li class="text-info">Please review the DA and marked as ECGC checked by clicking the button ECGC check at top. Once DA Checked, will send to corporate.</li>
                ...
                <div class="row">
                     ...
                     <div class="col-md-12 form-group">
                       ...
                       <label>Buyer:</label>&nbsp;  <?= $party['party']?>
                        <p style="border: 1px solid black;border-style: dashed; padding: 10px;"><span><?= $party['address1']?></span></p>
                     </div>
                </div>
        ...
        <div class="card-block">
          ...
          <div class="row">
           ...
           <div class="row">
                ...
                <div class="col-md-12 form-group">
                  <label>DA Prepared By:</label>&nbsp; <?= $da_header['prepared_by'] ?>
                </div>
...
<div class="card mb-3">
   ...
   <div class="card-block">
       <div class="table-responsive">
        <table class="table table-bordered" width="350%" id="dataTable" cellspacing="0">
        <thead>
            <tr>
			    <th>S.No</th>
                <th>Product</th>
