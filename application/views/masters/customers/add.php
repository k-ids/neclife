...
<div class="card mb-3">
	...
	<div class="card-header">
		<i class="fa fa-table" style="color: green;"></i> <b>Add customer</b>
	</div>
	<div class="card-block">
		<form method="POST"  action="<?=base_url()?>masters/customer_add">
		  ...
		  <div class="form-group">
		  	...
		  	<input type="text" name="party" class="form-control" placeholder="Enter party name" id="party" value="<?= set_value('party') ?>">
		  	<?= form_error('party') ?>
		  </div>
		  <div class="form-group">	
