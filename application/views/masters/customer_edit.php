...
<?php echo validation_errors(); ?>
        ...
        <form method="POST" id="collapseExample" class="collapse" action="<?=base_url()?>masters/customer_add">
						...
						<div class="form-group">	
							...
							<input type="text" name="address1" class="form-control" placeholder="Enter Address 1" id="address1">  
						</div>
						<div class="form-group">	
							<label for="email">Address 2:</label>
							<input type="text" name="address2" class="form-control" placeholder="Enter Address 2" id="address2">  
						</div>
						<div class="form-group">	
							<label for="email">Address 3:</label>
							<input type="text" name="address3" class="form-control" placeholder="Enter Address 3" id="address3">  
						</div>
						<div class="form-group">	
						...
						<div class="form-group">	
							...
							<input type="text" name="fax" class="form-control" placeholder="Enter Fax" id="fax">  
						</div>
						<div class="form-group">	
							<label for="email">Bank Details:</label>
							<input type="text" name="bankdetails" class="form-control" placeholder="Enter Bank Details" id="bankdetails">  
						</div>
						<div class="form-group">	
							<label for="email">ECGC INR:</label>
							<input type="text" name="ecgcinr" class="form-control" placeholder="Enter ECGC INR" id="ecgcinr">
						</div>
