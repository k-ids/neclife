...
?>
            ...
            <div class="card mb-3">
                ...
                <div class="card-header">
                      <i class="fa fa-table" style="color: green;"></i> <b>Documents listing</b>
                </div>
                 <div class="card-block">
                     <label>Add documents required:</label>
					<form method="POST" class="form-inline" action="<?=base_url()?>masters/documentsrequired_add">
						<input type="hidden" name="action" value="add">
						<input type="text" name="documentsrequired" class="form-control col-md-3" placeholder="Enter documents required"  id="documentsrequired" value="<?= set_value('documentsrequired') ?>">  
