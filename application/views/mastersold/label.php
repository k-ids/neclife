            ...
            <div class="card mb-3">
                ...
                <div class="card-header">
					<form method="POST" class="form-inline" action="<?=base_url()?>masters/label_add">
						...
						<input type="text" name="label" class="form-control" placeholder="Add Label" id="label" data-toggle="tooltip" title="Add Label" value="<?= set_value('label') ?>">  
						<button type="submit" class="btn btn-primary"data-toggle="tooltip" title="Add Label">+</button>
