            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <a href="javascript:void(0)" id="delete-user-<?= $value["id"]?>" data-url="<?=base_url().'administrator/delete_user/'.$value["id"] ?>"  data-toggle="tooltip" data-placement="top" title="Delete user">
