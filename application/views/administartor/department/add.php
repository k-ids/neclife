...
<div class="card mb-3">
   ...
   <div class="card-header">
      <i class="fa fa-keyboard-o" style="color: green;"></i>&nbsp;<b>Add Department</b>
      <p class="text-danger pull-right">All fields are mandatory.</p>
   </div>

   <div class="card-block">
      <form method="POST"  action="<?=base_url()?>administrator/create_department">
      
         <div class="form-group">   
            <label for="email">Department:</label>
            <input type="text" name="department" class="form-control" placeholder="Enter department name" id="department" value="<?= set_value('department')?>">  
