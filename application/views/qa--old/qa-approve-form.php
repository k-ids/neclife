...
<div class="card mb-3">
   <div class="card-block">
         ...
         <li class="text-info">This packing list is checked by: <b><?= !empty($packing_list[0]['checked_by']) ? $packing_list[0]['checked_by'] :'NIL'; ?></b>
         </li>
             ...
             <div class="row">
              <div class="col-md-12 form-group">
                  <label>QA Remarks:</label>
                   <textarea rows="3" cols="3" class="form-control" name="qa_remarks"  required=""><?= set_value('qa_remarks',!empty($packing_list[0]['qa_remarks']) ? $packing_list[0]['qa_remarks'] :'' ) ?></textarea>
                   <?= form_error('qa_remarks') ?>
              </div>
          </div>
