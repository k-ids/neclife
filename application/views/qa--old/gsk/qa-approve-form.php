      ...
      <div class="card-block">
         ...
         <div class="row">
          ...
          <div class="form-group col-md-6">
                 ...
                 <input class="form-control" type="text" name="checked_by" value="<?= $gsk_packing['checked_by']?>" readonly>
                 
          </div>

           <div class="form-group col-md-6">
                 <label>Approved By:</label>
                 <input class="form-control" type="text" name="checked_by" value="<?= $this->session->userdata('username') ?>" readonly>
                 
          </div>

          <div class="form-group col-md-12">
                 <label>QA Remarks:</label>
                 <textarea class="form-control" rows="2" cols="2" name="qa_remarks"><?= !empty($gsk_packing['qa_remarks']) ? $gsk_packing['qa_remarks'] : ''?></textarea> 
          </div>
