         ...
         <table class="table table-bordered packing-list-table" width="250%" id="dataTable" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a class="btn btn-primary" href="<?= base_url().$this->router->fetch_class().'/packing_list_manager_qa_approve_form/'.$value['da_no'].'/'.$value['product_form']?>"><i class="fa fa-refresh"></i>&nbsp;Select</a>
                  </td>
               </tr>
                 <?php }  } ?> 
            </tbody>
