   ...
   <div class="card-block">
             <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <input class="form-control" type="text" name="manager_qa" value="<?= !empty($packing_list[0]['manager_qa']) ? $packing_list[0]['manager_qa'] : $this->session->userdata('username'); ?>" readonly>
              </div>
