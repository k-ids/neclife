...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().'logistics/da_approve'?>">DA Final Approve Form</a></li>
</ol>
<!-- Example Tables Card -->

<div class="card mb-3">
   <div class="card-header">
      <i class="fa fa-dashcube" style="color: green;"></i>&nbsp;<b>DA Final Approve Form</b>
   </div>
      <div class="card-block">
          <form action="<?= base_url().'logistics/da_final_approve_form/'.$da_header['id']?>" method="POST">
           
            <a href="<?= base_url().'logistics/da_approve'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>

               <input type="hidden" name="approve" value="true">
               <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to provide final approvel to DA"><i class="fa fa-floppy-o"></i>&nbsp;Final Approve</button>
            <form>
      </div>
</div>
<div class="card mb-3">
      ...
      <div class="card-block">
       <p><strong>Note:</strong></p>
         <ul>
          <li class="text-success"> This DA has been successfully checked by:&nbsp;<b><?= getUserName($findOne['checked_by']) ?></b> ,
            ...
            <br>
             DA Outstanding checked By : <b><?= getUserName($findOne['outstanding_check_by'])?></b> <br>

             DA Accounts Approved By : <b><?= getUserName($findOne['accounts_approved_by'])?></b> <br>
             
            

          <li class="text-info">Please review the DA and provide final approval.</li>
