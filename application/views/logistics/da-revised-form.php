...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?=base_url().'logistics/da_revised'?>">DA Revised</a></li>
   <li class="breadcrumb-item">Revised Form</li>

   </li>
</ol>
<!-- Example Tables Card -->
<form method="POST" action="<?= base_url().'logistics/revised_da/'.$findOne['id']?>">

<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b>DA Revised Form</b>
   </div>

       <div class="card-block">
            
            <a href="<?= base_url().'logistics/da_revised'?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="fa fa-search"></i>&nbsp;Find</a>

            <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to revised the DA"><i class="fa fa-floppy-o"></i>&nbsp;Save</button>
      </div>
</div>
   ...
   <div class="card-block">
        ...
        <div class="row">
              ...
              <div class="col-md-6 form-group">
               <label>Old DA No:</label>
                  <input class="form-control" type="text" name="old_number" value="<?= $findOne['da_no'] ?>" readonly>
              </div>

              <div class="col-md-6 form-group">
               <label>Revised DA No:</label>
                 <input class="form-control" type="text" name="revised_number" value="<?= $findOne['da_no'].'-R' ?>" readonly>
              </div>
