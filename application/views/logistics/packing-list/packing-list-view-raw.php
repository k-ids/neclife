...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">Packing List - View(Raw)</li>
...
<div class="card mb-3">
   <div class="card-block">
         ...
         <a style="float:right;" class="btn btn-danger" href="<?= base_url().'logistics/packing_list_raw_view_pdf/'. $this->uri->segment(3).'/'. $this->uri->segment(4)?>"><i class="fa fa-files-o"></i>&nbsp;Download as PDF</a>
...
<div class="card mb-3">
   <div class="card-block">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="noBorder">
              <tr>
                <td colspan="2" align="center"><strong>PACKING LIST RAW DATA</strong></td>
