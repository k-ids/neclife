...
<div class="card mb-3">
   <div class="card-block">
         ...
         <a style="float:right;" class="btn btn-danger" href="<?= base_url().'logistics/packing_list_raw_pdf/'. $this->uri->segment(3).'/'. $this->uri->segment(4)?>"><i class="fa fa-files-o"></i>&nbsp;Download as PDF</a>
