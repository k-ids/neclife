...
<form method="POST"  action="<?=base_url().'logistics/da_sample_add'?>">
        ...
        <div class="card-block">
          ...
          <div class="row">
              ...
              <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="gst_amount" id="gst_amount" class="form-control"/>
                  <?//= form_error('gst_amount'); ?>
              </div>

              <div class="col-md-6 form-group">
                  <label>Commission  Amount For Capsule:<small class="text-success">( Total commission )</small></label>
                  <input type="text" name="comm_amount_for_capsule" id="comm_amount_for_capsule" class="form-control"/>
