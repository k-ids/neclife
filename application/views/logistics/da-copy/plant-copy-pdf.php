			...
			<tr>
				<td class="noPadding"><table class="noOuterBorder" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="noPadding"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="invoice">
							<tr style="border-bottom: 1px solid #000;">
								...
								<th align="right" style="text-align: right;"></th>
								<th align="right" style="text-align: right;"></th>
								<th align="right" style="text-align: right; border-right:none;"></th>
							</tr>
							<?php if(!empty($da_items) ) {
                                $counter = 0;
                                foreach($da_items as $daitems) {
							...
							<tr>
							    <td align="right"></td>
                                <td align="right"></td>
                                <td align="right" style="width: 100px;"><?= ($daitems['rate']) - ($daitems['freight']) ?></td>
                                <td align="right"></td>
                                <td align="right"></td>
                                <td align="right"></td>
                                <td align="right" style="border-right:none;"></td>
							</tr>
						     <?php } }   else {?> 
                             <tr>
				    ...
				    <?php } ?>
				    	     <tr>
						<td class="noPadding">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="invoice">
								<tr>
