...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">DA Account Copy</li>
...
<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-table" style="color: green;"></i> <b>DA Account Copy</b>
   </div>
</div>
...
<div class="card mb-3">
   <div class="card-block">
      ...
      <form method="POST" action="<?= base_url().'logistics/da_account'?>">
         ...
         <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                      <a href="<?= base_url().'logistics/da_account_copy/'.$value['id'] ?>" class="btn btn-info"><i class="fa fa-recycle"></i>&nbsp;Select</a>
