...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().'logistics/da_sample'?>">DA Sample</a></li>
...
<div class="card mb-3">
   <div class="card-header">
      <i class="fa fa-dashcube" style="color: green;"></i>&nbsp;<b>DA Sample Preparation</b>
   </div>
      <div class="card-block">
            <a href="<?= base_url().'logistics/da_sample'?>" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;New</a>
            <a href="<?= base_url().'logistics/da_sample'?>" class="btn btn-warning"><i class="fa fa-search"></i>&nbsp;Find</a>
            
      </div>
</div>
<form method="POST"  action="<?=base_url().'logistics/da_sample_edit/'.$da_header['id']?>">
          ...
          <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <div class="col-md-4 form-group">
                  ...
                  <input type="text" name="gst_rate" id="gst_rate" class="form-control" value ="<?= set_value('gst_rate', $da_header['gst_per'])?>">
                  <?//= form_error('gst_rate'); ?>
              </div>
     ...
     <div class="card mb-3">
        <div class="col-md-12">
            <div class="card-block">
                  ...
                  <a href="<?= base_url().'logistics/da_sample'?>" class="btn btn-warning"><i class="fa fa-times"></i>&nbsp;Cancel</a>
