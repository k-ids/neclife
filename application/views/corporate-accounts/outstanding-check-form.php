...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/da_outstanding_check'?>">DA Outstanding Check</a></li>
</ol>
<!-- Example Tables Card -->
<form action="<?= base_url().$this->router->fetch_class().'/'.$this->router->fetch_method().'/'.$da_header['id']?>" method="POST">
   <div class="card mb-3">
      <div class="card-header">
         <i class="fa fa-dashcube" style="color: green;"></i>&nbsp;<b>DA Outstanding Check</b>
      </div>
      <div class="card-block">
         ...
         <button type="Submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click me to check the DA"><i class="fa fa-floppy-o"></i>&nbsp;Outstanding Check</button>
      </div>
   </div>
   <div class="card mb-3">
      <div class="card-block">
         ...
         <ul>
            ...
            <li class="text-info">Please review the DA and marked as outstanding checked by clicking the button Outstanding check at top. Once DA Checked, will send to account approval.</li>
        ...
        <thead>
           ...
           <tbody id="row"> 
            <?php for($i = 0; $i <= 2; $i++) { ?>
              ...
              <tr>
                <td>
                   <input style="width:10pc" type="text" name="outstanding[]" class="form-control" placeholder="Enter Total Outstanding" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="ageing[]"  class="form-control" placeholder="Enter Ageing" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="0_30_days[]" class="form-control" placeholder="" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="31_60_days[]"  class="form-control" placeholder="" value="" >
                </td>
                <td>
                   <input style="width:10pc" type="text" name="61_95_days[]" class="form-control" placeholder="" value="">
                </td>
                <td>
                  <input style="width:10pc" type="text" name="96_120_days[]"  class="form-control" placeholder="" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="121_180_days[]"  class="form-control" placeholder="" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="181_365_days[]" id="181_365_days" class="form-control" placeholder="" value="" >
                </td>
                <td>
                  <input style="width:10pc" type="text" name="more_than_365_days[]" class="form-control" placeholder="" value="">
                </td>
              </tr>  
