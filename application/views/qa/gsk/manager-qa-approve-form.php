...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">Manager QA</li>
   <li class="breadcrumb-item"><a href="<?= base_url().$this->router->fetch_class().'/gsk_packing_list'?>">GSK Packing List</a></li>
...
<form action="<?= base_url(). $this->router->fetch_class(). '/'.$this->router->fetch_method().'/'.$this->uri->segment(3) ?>" method="POST">
  <div class="card mb-3">
      <div class="card-block">
        ...
        <br>
          ...
          <input type="hidden" name="gsk_da" value="<?= $da_header['da_no'] ?>">
          <input type="hidden" name="da_no" value="<?= $gsk_packing['da_no'] ?>">
          <div class="row">

            <div class="form-group col-md-6">
              <label>Party Name</label>
               <input type="text" class="form-control" name="buyer_name" value="<?= $gsk_packing['party_name'] ?>" required readonly>
            </div>
            <div class="form-group col-md-6">
              <label>Product Name:</label>
              <input type="text" class="form-control" name="product" value="<?= $gsk_packing['product_name'] ?>" required readonly>
            </div>
          
            <div class="form-group col-md-6">
              <label>Qauntity</label>
               <input type="text" class="form-control" name="qauntity" value="<?= $gsk_packing['qauntity'] ?>" required readonly>
            </div>
            <div class="form-group col-md-6">
              <label>Purchase Order No.</label>
              <input type="text" class="form-control" name="po_no" value="<?= $gsk_packing['po_no'] ?>" required readonly>
            </div>
  ...
  <div class="card mb-3">
      <div class="card-block">
         ...
         <div class="row">
          ...
          <div class="form-group col-md-6">
            <label>Manager QA Approved By:</label>
            <input type="text" value="<?= $gsk_packing['checked_by'] ?>" class="form-control" readonly required>
          </div>

          <div class="form-group col-md-6">
            <label>QA Approved By:</label>
            <input type="text" value="<?= $gsk_packing['approved_by'] ?>" class="form-control" readonly required>
          </div>

          <div class="form-group col-md-12">
            <label>QA Remarks:</label>
            <input type="text" value="<?= $gsk_packing['qa_remarks'] ?>" class="form-control" readonly required>
          </div>

          <div class="form-group col-md-12">
                 <label>Manager QA Remarks:</label>
                 <textarea class="form-control" rows="2" cols="2" name="manager_remarks"><?= !empty($gsk_packing['manager_remarks']) ? $gsk_packing['manager_remarks'] : ''?></textarea> 
          </div>

      </div>

       <button class="btn btn-primary" type="submit"><i class="fa fa-floppy-o"></i>&nbsp;Save</button>
      <a href="<?= base_url().$this->router->fetch_class().'/gsk_packing_list' ?>" class="btn btn-warning"><i class="fa fa-times"></i>&nbsp;Cancel</a>
