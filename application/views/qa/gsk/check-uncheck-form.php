        ...
        <br>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
             ...
             <?php
                   $explode = explode(' ', $gsk_packing['qauntity']);
             ?>
            <div class="form-group col-md-6">
              <label>Qauntity</label>
               <input type="text" class="form-control" name="qauntity" value="<?= number_format((float)$explode[0], 2).' Kg' ?>" required readonly>
            </div>
            <div class="form-group col-md-6">
  ...
  <div class="card mb-3">
      ...
      <div class="row">
          <div class="col-md-6 form-group">
              <label>Check/Uncheck GSK List:</label>
                  <input type="checkbox" id="checkbox-1" name="check_uncheck" value="1" <?= !empty($gsk_packing['checked_by']) ? 'checked' : ''  ?> >
