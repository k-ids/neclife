              ...
              <div class="row">
                <div class="form-group col-md-12">
                 ...
                 <div class="form-group col-md-2">
                   <input type="text" name="travel_sample1" value="<?= !empty($gsk_packing) ? $gsk_packing['travel_sample1'] : ''  ?>" class="form-control" id="travel_sample1">
                 </div>

                  <div class="form-group col-md-2">
                   <input type="text" name="travel_sample2" value="<?= !empty($gsk_packing) ? $gsk_packing['travel_sample2'] : ''  ?>" class="form-control" id="travel_sample2">
                 </div>

                  <div class="form-group col-md-2">
                   <input type="text" name="travel_sample3" value="<?= !empty($gsk_packing) ? $gsk_packing['travel_sample3'] : ''  ?>" class="form-control" id="travel_sample3">
                 </div>
              </div>
