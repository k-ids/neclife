...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">Packing List(New) - Plant</li>
...
<div class="alert alert-info">
  <strong>Info!</strong> Listing of all for Packing List(New) - Plant.
</div>
         ...
         <table class="table table-bordered" width="150%" id="dataTable" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                      <a href="<?= base_url().$this->router->fetch_class().'/add_packing_list/'.$value['id'] ?>" class="btn btn-info"><i class="fa fa-recycle"></i>&nbsp;Select</a>
