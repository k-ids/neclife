...
<div class="card mb-3">
   <div class="card-block">
      <div style="float: right;">
         <a href="<?= base_url().$this->router->fetch_class().'/pdf_gsk_packing_invoice/'.$invoice_data['invoice_id']?>" class="btn btn-danger"><i class="fa fa-files-o"></i>&nbsp;Download GSK Packing List</a>
